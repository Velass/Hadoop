...
type exercices-MR\data\Spotify_Most_Streamed_Songs.csv | python exercices-MR\exercices\exercice1\mapper.py | sort | python exercices-MR\exercices\exercice1\reducer.py